...
const STATUS_ORDER: RobotStatus[] = [
  'LOW_BATTERY', 'ERROR', 'CLEANING', 'RETURNING_TO_DOCK', 'UPDATING', 'CHARGING', 'IDLE',
]
...
export function Dashboard() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* ロボットカード一覧 */}
      <div>
        <h2 className="mb-3 text-sm font-semibold uppercase tracking-wide text-slate-500">ロボット一覧</h2>
